...
function CadminDashboard() {
    ...
    return <>
        ...
        <div className={authData?.isMaster ? "mt-6 grid grid-cols-1 gap-4 md:grid-cols-3" : "mt-6 grid grid-cols-1 gap-4 md:grid-cols-2"}>
